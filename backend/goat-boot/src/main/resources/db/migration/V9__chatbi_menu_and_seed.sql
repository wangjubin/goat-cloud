...
FROM ai_stategraph sg,
     (VALUES
        ('intent_recognition', '意图识别', 'INTENT_RECOGNITION', NULL, 1, 30000),
        ('schema_recall', 'Schema召回', 'SCHEMA_RECALL', NULL, 2, 30000),
        ('nl2sql', 'NL2SQL生成', 'NL2SQL', '{"modelType":"CHAT"}', 3, 60000),
        ('human_feedback', '人工确认', 'HUMAN_FEEDBACK', NULL, 4, 300000),
        ('sql_execution', 'SQL执行', 'SQL_EXECUTION', NULL, 5, 30000),
        ('report_generation', '报告生成', 'REPORT_GENERATION', NULL, 6, 60000)
